...
#
# Read from claude 2.1.233 on Linux, Windows and macOS. In-process: no.
            ...
            def __call__(  # type: ignore[override]
                ...
                **flags: Any,
                ...
                Args:
                    ...
                    yes: For a plugin installed by running a marketplace-declared command: accept the displayed command without the confirmation prompt (required when stdin or stdout is not a TTY). Added in 2.1.229.
                """
                ...
            @property
            ...
            def __call__(  # type: ignore[override]
                ...
                **flags: Any,
                ...
                Args:
                    ...
                    yes: For a plugin installed by running a marketplace-declared command: accept a changed command without the confirmation prompt (required when stdin or stdout is not a TTY). Added in 2.1.229.
                """
                ...
            @property
